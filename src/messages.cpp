...
void start_message()
{
  log() << endl << endl << "  CODE NAME, please don't call me cj" << endl
      << endl << "  Authors: PK Notz, DZ Turner" << endl << endl;
  ...
  log() << "  Date:    " << month << "/" << current->tm_mday << "/" << year
      << endl;
  log() << "  Time:    " << current->tm_hour << ":" << current->tm_min << ":"
      << current->tm_sec << endl;
}
