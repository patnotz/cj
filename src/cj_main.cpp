...
int main(int argc, char * argv[])
{
  ...
  desc.add_options()("help,h", "produce help message")("input,i",
    po::value<std::string>(), "input file")("mesh,m", po::value<std::string>(),
    "input mesh database (overrides input file)")("results,r",
    po::value<std::string>(), "output results database (overrides input file)")(
  ...
  if (vm.count("results"))
  {
    ...
    log() << "Override output results file name: " << resultsFileName
        << std::endl;
  }
